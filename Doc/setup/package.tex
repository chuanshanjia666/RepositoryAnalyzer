...
%\usepackage{txfonts}   % 如果你希望和 Word 的默认值保持一致，请使用此宏包（XeLaTeX 下不兼容）
\usepackage{helvet}
...
%\usepackage{ccmap}      % 使pdfLatex生成的文件支持复制等（XeLaTeX 不需要此包）
\usepackage[unicode,
            ...
            urlcolor=blue,
            breaklinks=true
            ]{hyperref} % 生成有书签和超链接的 pdf，使用 unicode 支持 UTF-8

% 参考文献（使用现代的 biblatex + biber 方案）
\usepackage[backend=biber,style=gb7714-2015]{biblatex}
\addbibresource{body/reference.bib}
