...
分析工具基于Python开发，核心依赖以下开源库：GitPython用于与本地Git仓库交互，遍历提交历史、提取提交哈希/作者/时间戳/文件变更统计等元数据；Matplotlib作为可视化引擎，配置中文字体（SimHei/Source Han Sans CN）确保中文标签正常显示；Pandas用于高效处理时间序列数据，支持数据聚合、重采样与统计分析；Collections（Counter）则用于快速统计作者提交次数、关键词频率等数据。
